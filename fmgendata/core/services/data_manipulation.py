...
#TODO: Criar pipeline de dados confore estrutura recoendada:

"""
extract: só lê arquivos do FM e devolve DataFrames “crus”

transform: limpa e padroniza (nomes de colunas, tipos, moeda, “1.2M”, datas, etc.)

load: escreve no SQLite / atualiza tabelas

pipeline: chama tudo na ordem e lida com logs/erros
